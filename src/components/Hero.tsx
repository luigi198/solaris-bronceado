    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 w-full">
        <div className="max-w-3xl">
          ...
          >
            Tu bronceado{" "}
            <span className="text-brand-gold">perfecto</span>,{" "}
            <span className="block">todo el año</span>
          </h1>

          <p className="text-lg md:text-xl text-white/80 leading-relaxed mb-8 max-w-2xl">
            Técnica brasileña profesional en Costa Rica. Tono dorado natural y
            uniforme desde la primera sesión, sin sol ni rayos UV.
          </p>
